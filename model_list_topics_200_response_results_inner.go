...
func (o *ListTopics200ResponseResultsInner) GetUpdatedDate() time.Time {
...
// and a boolean to check if the value has been set.
func (o *ListTopics200ResponseResultsInner) GetUpdatedDateOk() (*time.Time, bool) {
	if o == nil || IsNil(o.UpdatedDate) {
		return nil, false
	}
...
func (o *ListTopics200ResponseResultsInner) SetUpdatedDate(v time.Time) {
	o.UpdatedDate = &v
}
